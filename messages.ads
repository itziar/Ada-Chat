...
procedure Send(Bett: CM.Message_Type; EP_H_Creat: LLU.End_Point_Type; Seq_N_In: CM.Seq_N_T; EP_H_Rsnd: LLU.End_Point_Type; EP_R_Creat: LLU.End_Point_Type; Nick : ASU.Unbounded_String; Text: ASU.Unbounded_String; Confirm_Sent: Boolean; EP_H_Receive: LLU.End_Point_Type);
