package body Chat_Messages is
   ...
   begin
	...
	function Mess_Iguales (Mess_1, Mess_2 : Mess_Id_T) return Boolean is
	begin
	...
	function Mess_Menor (Mess_1, Mess_2 : Mess_Id_T) return Boolean is
	begin
	...
	function Mess_Mayor (Mess_1, Mess_2 : Mess_Id_T) return Boolean is
	begin
	...
	function Image_Mess (Mess : Mess_Id_T) return String is
	begin
	
		return "EP_H_Creat: " & Image_EP(Mess.EP) & " Seq_N:" 
					& Seq_N_T.Seq_N_Type'Image(Mess.Seq);
	
	end Image_Mess;
	
	function Image_Destinations (Dest : Destinations_T) return String is
	...
	function Image_Value (Value : Value_T) return String is
	begin
	
		return Image_EP(Value.EP_H_Creat) & Seq_N_T.Seq_N_Type'Image(Value.Seq_N);
